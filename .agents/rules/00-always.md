...
- **Everything AI-related lives in `conductor/`** except `.agents/`, which Antigravity discovers -
  `rules/`, `skills/` and `workflows/`. `conductor/rules/` is the source of truth - this file is a
