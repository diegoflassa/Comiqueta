...
|----|------|-------|--------------|-----------|
| KI-001 | KI-001_Viewer-Pinch-Zoom-Fix.md | Pinch-zoom gesture fix in viewer | Touching viewer gesture handling / zoom | `ViewerScreen.kt`, `globalIsPinchZoomActive`, `isPinchGestureInProgress` |
