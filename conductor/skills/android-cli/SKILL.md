...
<!-- Comiqueta context — Android comic reader (CBZ/CBR/CB7/CBT/PDF), 100% Jetpack Compose + Hilt + Room + SAF + Nav 3. See conductor/rules/CORE_RULES.md + INSTRUMENTED_TEST_STANDARD.md. -->
